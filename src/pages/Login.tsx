...
const getURL = () => {
    let url = import.meta.env.NEXT_PUBLIC_SITE_URL ?? 'http://localhost:5173/'
    url = url.includes('http') ? url : import.meta.env.NEXT_PUBLIC_SITE_URL;
...
function Login({ logOut, session }: any) {
                    ...
                    <div className="sm:py-18 gap container relative mx-auto grid grid-cols-12 px-6 py-16 md:gap-16 md:py-24 lg:gap-16 lg:px-16 lg:py-24 xl:px-20">
                        ...
                        <div className="col-span-12 md:col-span-5 lg:col-span-6">
                            <div className="!max-w-md">
                                <h3 className="text-2xl mb-8">Brad K</h3>
                                <p className="!mb-0">
                                    Welcome to User Management Platform.
                                </p>
                                <p className="text-scale-900 mt-0">
                                    Welcome to our User Management App,where people login,signup & Update their account Information
                                </p>
                            </div>
